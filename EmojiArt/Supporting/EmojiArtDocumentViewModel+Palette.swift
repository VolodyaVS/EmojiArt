...
extension EmojiArtDocumentViewModel {
    ...
    private(set) var paletteNames: [String: String] {
        get {
            UserDefaults.standard.object(forKey: EmojiArtDocumentViewModel.PalettesKey) as? [String: String] ?? [
                "😀😅😂😇🥰😉🙃😎🥳😡🤯🥶🤥😴🙄👿😷🤧🤡":"Faces",
                "🍏🍎🥒🍞🥨🥓🍔🍟🍕🍰🍿☕️":"Food",
                "🐶🐼🐵🙈🙉🙊🦆🐝🕷🐟🦓🐪🦒🦨":"Animals",
                "⚽️🏈⚾️🎾🏐🏓⛳️🥌⛷🚴‍♂️🎳🎼🎭🪂":"Activities"
        ...
        set {
            UserDefaults.standard.set(newValue, forKey: EmojiArtDocumentViewModel.PalettesKey)
